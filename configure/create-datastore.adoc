...
VMware vSphere 7.0でNVMe/FCを使用する方法の詳細については、 https://docs.netapp.com/us-en/ontap-sanhost/nvme_esxi_8.html["ONTAP NVMe/FC Host Configuration Guide"^]および http://www.netapp.com/us/media/tr-4684.pdf["TR-4684"^]を参照してください。
